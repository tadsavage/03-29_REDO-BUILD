...
{
    const string UXML_PATH          = "Assets/3. UI/7. EmployeeUI/EmployeeListPanel.uxml";
    const string ITEM_TEMPLATE_PATH = "Assets/3. UI/7. EmployeeUI/EmployeeListItem.uxml";
    const string PANEL_SETTINGS_PATH = "Assets/3. UI/5.ToolsWindow/ToolsWindowPanelSettings.asset";
