...
public class EditorPrefabCreationTool : EditorWindow
{
    ...
    // ── Paths ─────────────────────────────────────────────────────────────────
    private const string SODir   = "Assets/1. Scripts/3. ScriptableObjects/PrefabSOs";
    private const string IconDir = "Assets/1. Scripts/3. ScriptableObjects/Icons";
    private const string PrefabRootDir = "Assets/2. Prefabs";
